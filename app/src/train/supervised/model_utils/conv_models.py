...
from model_utils.models import ODEBlock
...
class ConvODENet(nn.Module):
    ...
    def __init__(self, device, img_size, num_filters, output_dim=1,
        ...
        odefunc = ConvODEFunc(None, img_size, num_filters, augment_dim,
                              time_dependent, non_linearity)

        self.odeblock = ODEBlock(None, odefunc, is_conv=True, tol=tol,
                                 adjoint=adjoint)
